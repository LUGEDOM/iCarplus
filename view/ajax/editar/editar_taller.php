<?php
    ...
    $sql = "UPDATE taller SET nombre='".$nombre."', cuit='".$cuit."', direccion='".$direccion."', localidad='".$localidad."', telefono='".$telefono."', celular='".$celular."', estado='".$estado."' WHERE id='".$id."' ";
    $query = mysqli_query($con,$sql);

    if ($query) {
        $messages[] = "El Taller ha sido actualizado con éxito.";
    } else {
